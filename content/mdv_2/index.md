...
## Located on the Breakwater at Faresmaathoda, Maldives
...
fetch('/data/MDV_2_Combined_Zephyra_Log_Error.csv')
.then(r => r.text())
.then(text => {
...
### 30-Day Summary
![30 Day Graph](images/MDV_2_30_Day.svg)

### 5-Day Summary
![5 Day Graph](images/MDV_2_5_Day.svg)
...
<script>
fetch('/data/MDV_2_Current_Zephyra_Parameters.json')
.then(r => r.json())
.then(d => {
const rows = [
['Station', d.station],
...
<script>
fetch('/data/MDV_2_Current_Lidar_Parameters.json')
.then(r => r.json())
.then(d => {
...
### Lidar Parameters
![Lidar Parameters](images/MDV_2_Lidar_ScanParameters.svg)

### Zephyra Parameters
![Zephyra Parameters](images/MDV_2_Zephyra_Parameters.svg)

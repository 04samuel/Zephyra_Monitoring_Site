...
fetch('/data/LPD_2_Combined_Zephyra_Log_Error.csv')
.then(r => r.text())
.then(text => {
...
### Lidar Parameters
![Lidar Parameters](images/LPD_2_Lidar_ScanParameters.svg)

### Zephyra Parameters
![Zephyra Parameters](images/LPD_2_Zephyra_Parameters.svg)

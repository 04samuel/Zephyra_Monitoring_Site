...
fetch('/data/LPD_3_Combined_Zephyra_Log_Error.csv')
.then(r => r.text())
.then(text => {
...
### 30-Day Summary
![30 Day Graph](images/LPD_3_30_Day.svg)

### 5-Day Summary
![5 Day Graph](images/LPD_3_5_Day.svg)
...
<script>
fetch('/data/LPD_3_Current_Zephyra_Parameters.json')
.then(r => r.json())
.then(d => {
const rows = [
['Station', d.station],
...
<script>
fetch('/data/LPD_3_Current_Lidar_Parameters.json')
.then(r => r.json())
.then(d => {
...
### Lidar Parameters
![Lidar Parameters](images/LPD_3_Lidar_ScanParameters.svg)

### Zephyra Parameters
![Zephyra Parameters](images/LPD_3_Zephyra_Parameters.svg)

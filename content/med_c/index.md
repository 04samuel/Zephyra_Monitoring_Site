...
fetch('/data/MED_C_Combined_Zephyra_Log_Error.csv')
.then(r => r.text())
.then(text => {
...
### 30-Day Summary
![30 Day Graph](images/MED_C_30_Day.svg)

### 5-Day Summary
![5 Day Graph](images/MED_C_5_Day.svg)
...
<script>
fetch('/data/MED_C_Current_Zephyra_Parameters.json')
.then(r => r.json())
.then(d => {
const rows = [
['Station', d.station],
...
<script>
fetch('/data/MED_C_Current_Lidar_Parameters.json')
.then(r => r.json())
.then(d => {
...
### Lidar Parameters
![Lidar Parameters](images/MED_C_Lidar_ScanParameters.svg)

### Zephyra Parameters
![Zephyra Parameters](images/MED_C_Zephyra_Parameters.svg)
